...
export default function About(props) {
  ...
  <div className="accordion-item" style={mystyle}>
    ...
    <div id="collapseOne" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
      ...
      Textutils gives you a way to analyze your text efficiently.Be it word count or character count.
      </div>
    </div>
  </div>
  <div className="accordion-item" style={mystyle}>
    ...
    <div id="collapseTwo" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
      <div className="accordion-body "style={mystyle}>
       Textutils is a free character counter tool that provides instant character count & word count statistics for given text. Textutils reports number of words and characters.
...
This word counter software works in any web browser such as Chrome, Firefox,Internet explorer,Safari,Opera.
       It suits to count characters in Facebook,Blogs,books,essays,etc.
      </div>
    </div>
  </div>
</div>
